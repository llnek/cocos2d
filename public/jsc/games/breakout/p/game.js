...
GameLayer = _scenes2.default.XGameLayer.extend({
  ...
  spawnPlayer: function spawnPlayer() {
    _asterix2.default.factory.bornPaddle();
  },
   ...
   * @private
   */
  onPlayerKilled: function onPlayerKilled() {
...
var xbox = /** @lends xbox# */{
  ...
  reify: function reify(options) {
    ...
    scene.onmsg('/game/bricks/killed', function (msg) {
      _asterix2.default.main.onBrickKilled(msg);
