 ...
 * @class Missile
 */
xbox.Missile = _asterix2.default.Ashley.compDef({
  ...
  constructor: function constructor(sprite, attackMode) {
 ...
 * @class Bomb
 */
xbox.Bomb = _asterix2.default.Ashley.compDef({
 ...
 * @class Enemy
 */
xbox.Enemy = _asterix2.default.Ashley.compDef({
  ...
  constructor: function constructor(sprite, arg) {
 ...
 * @class Ship
 */
xbox.Ship = _asterix2.default.Ashley.compDef({
  ...
  constructor: function constructor(sprite, spriteX) {
 ...
 * @class Spark
 */
xbox.Spark = _asterix2.default.Ashley.compDef({
  ...
  constructor: function constructor(sp1, sp2) {
    this.duration = 0.7;
    this.sprite2 = sp2;
    this.ctor(sp1);
    this.scale = 1.2;
  ...
  inflate: function inflate(options) {
    ...
    var scaleBy = cc.scaleBy(this.duration, 3, 3),
        ...
        seq = cc.sequence(cc.fadeOut(this.duration), cc.callFunc(this.destroy, this));
 ...
 * @class Explosion
 */
xbox.Explosion = _asterix2.default.Ashley.compDef({
  ...
  inflate: function inflate(options) {
    ...
    this.sprite.setVisible(true);
    this.status = true;
    this.sprite.runAction(cc.sequence(cc.animate(this.animation), cc.callFunc(this.deflate, this)));
  }
});
 ...
 * @class HitEffect
 */
xbox.HitEffect = _asterix2.default.Ashley.compDef({
  ...
  inflate: function inflate(options) {
    ...
    this.sprite.runAction(cc.sequence(cc.fadeOut(0.3), cc.callFunc(this.deflate, this)));
  }
});
