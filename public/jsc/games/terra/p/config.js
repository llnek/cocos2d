...
var xbox = sjs.merge(_cfg2.default, {
  ...
  levels: {
    "1": {
      ...
      cfg: {
        enemyMax: 6,
        enemies: [{ style: "*", time: 2, types: [0, 1, 2] }, { style: "*", time: 5, types: [3, 4, 5] }]
      }
  ...
  runOnce: function runOnce() {
    ...
    cc.spriteFrameCache.addSpriteFrames(_asterix2.default.getPList('op-pics'));
    cc.spriteFrameCache.addSpriteFrames(_asterix2.default.getPList('explosions'));
    cc.spriteFrameCache.addSpriteFrames(_asterix2.default.getPList('back-tiles'));
  }
});
