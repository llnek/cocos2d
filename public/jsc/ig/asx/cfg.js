...
var xbox = /** @lends xbox# */{
  ...
  game: {
    ...
    start: _asterix2.default.ptypes.start,
    preloadLevels: true,
    scale: 1,
    sfx: 'mp3',
    landscape: false,
  ...
  csts: {
    ...
    NETP: _asterix2.default.gtypes.ONLINE_GAME,
    HUMAN: _asterix2.default.gtypes.P1_GAME,
    BOT: _asterix2.default.gtypes.P2_GAME,

    GAME_MODE: _asterix2.default.gtypes.P1_GAME,
    TILE: 8,
    S_OFF: 4,
    GAME_ID: ''
  },
